...
const Page = async ({ searchParams }) => {
  const { id, poster_path } = await searchParams; // ✅ no await
  console.log("id", id);

  const res = await api.get(ENDPOINT.getTvShowsDetails(id));
  const videos = await api.get(ENDPOINT.getTvShowsVideos(id));
